        ...
        with conn.cursor() as cur:
            cur.execute(
                ...
                CREATE TABLE IF NOT EXISTS tad_parcels (
                    ...
                    owner_addr TEXT,
                    owner_city TEXT,
                    owner_citystate TEXT,
                    owner_zip VARCHAR(16),
                    owner_zip4 VARCHAR(8),
                    situs_addr TEXT,
            ...
            cur.execute("CREATE INDEX IF NOT EXISTS idx_tad_parcels_situs_addr_upper ON tad_parcels (upper(situs_addr) text_pattern_ops)")
        conn.commit()
    finally:
        release_conn(conn)
