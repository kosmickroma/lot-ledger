...
function applyPropelioClientFilters() {
  ...
  // Multi-neighborhood port: 2-arg call — the Set-based OR-gate is
  // reference-memoized inside compPassesPropelioFilters (_nbhdNormSetFor).
  // (AI-mode seam + fact-filter post-pass stay on develop — not ported.)
